...
public class HiddenStringUtils {
    ...
    private static final String SEQUENCE_HEADER = "" + ChatColor.UNDERLINE;
    private static final String SEQUENCE_FOOTER = "" + ChatColor.ITALIC;


    public static String hide(String hiddenString) {
    ...
    public static String unHide(String input) {
